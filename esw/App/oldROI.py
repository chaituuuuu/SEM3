...
def get_video_path():
    try:
        ...
        return '/home/chaitu/Downloads/hello.mp4'
...
def process_image(image, bounding_boxes, output_path, overlap_threshold=0.5):
    ...
    for i in range(rows):
        for j in range(cols):
            ...
            color = (0, 0, 255) if intersection_area > overlap_threshold * segment_area else (0, 255, 0)
...
while cap.isOpened():
    ...
    if frame_count % frame_interval == 0:
        ...
        process_image(frame, load_bounding_boxes(txt_path), final_image_path, overlap_threshold=0.4)
        print(f"Processed and saved: {final_image_path}")

    frame_count += 1

cap.release()
print("Inference completed and final results saved!")
